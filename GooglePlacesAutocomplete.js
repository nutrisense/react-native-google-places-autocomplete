  ...
  _request = (text) => {
    ...
    if (text.length >= this.props.minLength) {
      ...
      if (this.props.placesAPI === 'GoogleReverseGeocoding') {
        ...
        url = url + Qs.stringify({ key: this.props.query.key, ...this.props.GoogleReverseGeocodingQuery });
        url = url + '&address=' + encodeURIComponent(text)
      } else {
        url = 'https://maps.googleapis.com/maps/api/place/autocomplete/json?';
        url = url + Qs.stringify(this.props.query);
        url = url + '&input=' + encodeURIComponent(text);
      }
      request.open('GET', url);
      if (this.props.referer !== null) {
         request.setRequestHeader('Referer', this.props.referer)
